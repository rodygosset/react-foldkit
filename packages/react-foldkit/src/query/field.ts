...
export type FieldConfig<Name extends string, A, AI, E, EI, R> = Readonly<{
	name: Name
...
export function defineField<Name extends string, A, AI, E, EI, R>(config: FieldConfig<Name, A, AI, E, EI, R>) {
	...
	return {
		...
		watchSubscription,
		run,
	} satisfies Field<Name, typeof states.schema, typeof Message, R>
}
