...
const examples = [
	{
		to: "/counter",
		title: "Counter",
		blurb: "Model, Messages, and a pure update — the smallest REE loop.",
	},
	{
		to: "/todo",
		title: "Todo",
			...
			<div className="mx-auto flex w-full max-w-lg flex-1 flex-col justify-center px-6 py-16">
				<div className="animate-rise">
					...
					<p className="mt-5 max-w-sm text-base leading-relaxed text-muted-foreground">
						A small Foldkit-inspired loop for React: one Model, typed Messages, and
						Commands that stay outside the view.
					</p>
				</div>

				<Separator className="animate-rise my-10" style={{ animationDelay: "80ms" }} />
